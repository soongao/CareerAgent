# D12-process-recovery: Paused Tutor reconstructs from persisted transcript after process restart

File-backed recovery of interactive session metadata and transcript.
